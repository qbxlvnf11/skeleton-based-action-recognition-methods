...
sys.path.extend(['../'])
from preprocess import pre_normalization # from data_gen.preprocess import pre_normalization
...
def gendata(data_path, out_path, ignored_sample_path=None, benchmark='xview', part='eval'):
    if ignored_sample_path != None:
        ...
        ignored_samples = []
    print(' ===> ignored_samples:', len(ignored_samples))
    ...
    print(' ===> fp: num_of_data, channel, max_frame, num_joint, num_person_out')
    print(' ===> fp size:', fp.shape) # e.g. (N, 3, 300, 25, 2)
