...
from mmcv.utils.version_utils import digit_version as dv
...
def main():
    ...
    out_label = osp.join(cfg.work_dir, 'label.pkl') if args.out is None else args.out
