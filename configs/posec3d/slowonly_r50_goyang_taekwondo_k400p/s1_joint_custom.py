...
ann_file_train = 'data/181.고양시 태권도 데이터/01.데이터/1.Training.pkl'
ann_file_val = 'data/181.고양시 태권도 데이터/01.데이터/2.Validation.pkl'
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_goyang_taekwondo_k400p/s1_joint'
load_from = './weights/k400_posec3d-041f49c6.pth'
