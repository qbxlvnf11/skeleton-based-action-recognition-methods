...
class PoseDataset(BaseDataset):
    ...
    def load_pkl_annotations(self):
        ...
        if self.split:
            ...
            try:
                logger.info(' ===> img_shape of smaple data: ' + str(data['annotations'][0]['img_shape']))
                logger.info(' ===> original_shape of smaple data: ' + str(data['annotations'][0]['original_shape']))
            except Exception:
                pass
            logger.info(' ===> total_frames of smaple data: ' + str(data['annotations'][0]['total_frames']))
            logger.info(' ===> keypoint of smaple data: ' + str(data['annotations'][0]['keypoint'].shape))                
            logger.info('='*100)
