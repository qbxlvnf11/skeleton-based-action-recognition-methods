...
class Feeder(Dataset):
    def __init__(self, data_path, label_path,
        ...
        print(' ===> self.random_choose:', self.random_choose)
        print(' ===> self.random_shift:', self.random_shift)
        print(' ===> self.random_move:', self.random_move)
    ...
    def load_data(self):
        ...
        print(f' ===> self.label:', len(self.label))
